...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row textpad5" style="margin-bottom: 20px">
			<div class="col-sm ">
				<div>
					<a href="${pageContext.request.contextPath}/admin/home"><img src="${pageContext.request.contextPath}/Tester.png" height="47" class="rounded " alt="Tester">
				</div>
			</div>
			<div class="col-sm textpadp5">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item"><a class="nav-link disabled" href="#"><c:if
						...
						<li class="nav-item"><a class="nav-link enable" href="${pageContext.request.contextPath}/owner-data">My Profile</a></li>
